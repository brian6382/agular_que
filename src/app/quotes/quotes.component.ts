...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[] = [
    ...
    new Quote (4,'Kelvin','Programming','Communications tools don’t get socially interesting until they get technologically boring.','Clay Shirky',new Date(2019,7,7),0,0)
  ];
  get sortQuotes() {
